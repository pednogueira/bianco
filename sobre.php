		...
		<div class="wrap-body">
			<div id='cssmenu' class="align-center">
				<ul>
					...
					<li class='active'><a href='single.html'><span>Sobre</span></a></li>
					<li class='last'><a href='contact.php'><span>Contato</span></a></li>
				</ul>
			</div>
			<!-- <header class="">
				<div class="logo">
					...
					<article class="single-post zerogrid">
						<div class="row wrap-post"><!--Start Box-->
							<div class="entry-header">
								<span class="time">Um pouco sobre Henrico Bianco...</span>
								<h2 class="entry-title"><a href="#">Pintor, gravador, desenhista e ilustrador</a></h2>
							...
							<div class="entry-content">
								<div class="excerpt"><p>Nascido em 1918 na Itália na bela cidade de Roma teve interesse por arte aos 7 anos de idade.</p></div>
								<p>Seu aprendizado com mestres italianos até a idade de 18 anos quando em pleno fascismo conseguiu emigrar para o Brasil tornando-se um dos artistas que apesar de estrangeiro, toda e sempre, sua temática foi brasileira.</p>
